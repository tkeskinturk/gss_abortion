...
title: |
  ...
  | An Analysis with the GSS Panels
author:
...
[^Int]: In another specification, we estimated within-between models by specifying respondent sex as a cross-level interaction. BIC for the interaction models were lower than the ones without interaction (1425 < 1445 for Birth and 1449 < 1464 for Marriage).

```{r reg, fig.pos = "H", fig.align = "center"}

library(modelsummary)
m1_f <- readRDS("./abortion_models/m1.RDS")
m2_f <- readRDS("./abortion_models/m2.RDS")
m3_f <- readRDS("./abortion_models/m3.RDS")
m1_m <- readRDS("./abortion_models/m4.RDS")
m2_m <- readRDS("./abortion_models/m5.RDS")
m3_m <- readRDS("./abortion_models/m6.RDS")
